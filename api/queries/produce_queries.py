...
class ItemRepository(MongoQueries):
    ...
    def get_produce(self, item_id: str, account_id: str) -> Optional[ItemOut]:
        ...
        record = produce_queries.collection.find_one(
    ...
    def delete_produce(self, item_id: str, account_id: str) -> bool:
        produce_queries = MongoQueries(collection_name="produce")
        result = produce_queries.collection.delete_one(
            {"_id": ObjectId(item_id), "account_id": account_id})
    ...
    def get_all_produce(self,
        ...
        produce_queries = MongoQueries(collection_name="produce")
        try:
            records = produce_queries.collection.find(
    ...
    def add_produce(self, item: ItemIn,
