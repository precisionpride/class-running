...
def add_dairy(item: ItemIn, response: Response, account_data: dict =
...
def update_dairy(item_id: str, item: ItemIn, account_data:
...
def delete_dairy(item_id: str, account_data: dict =
                 Depends(authenticator.get_current_account_data),
...
def get_dairy(item_id: str, response: Response, account_data: dict =
              Depends(authenticator.get_current_account_data),
