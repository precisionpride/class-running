...
def add_beverage(item: ItemIn, response: Response, account_data: dict =
...
def get_all_beverages(account_data: dict =
                Depends(authenticator.get_current_account_data),
...
def update_beverage(item_id: str, item: ItemIn, account_data: dict =
                    Depends(authenticator.get_current_account_data),
...
def delete_beverage(item_id: str, account_data: dict =
                    Depends(authenticator.get_current_account_data),
...
def get_beverage(item_id: str, response: Response, account_data: dict =
                 Depends(authenticator.get_current_account_data),
